...
contains
  ...
  subroutine compute_cls
    ...
    do i=1,n_spline
       z_spline(i) = 0.d0 + (i-1)*3400.d0/(n_spline-1.d0)
    end do
    ...
    ! Bessel function j_lfunc test
    !------------------------------------------------------
    !| allocate(bessel(n_x_hires))
    !| do i=1,n_x_hires
    !|    bessel(i) = j_lfunc(17,k_hires(2000),x_hires(i))
    !|    write(13,'(2(E17.8))') x_hires(i), bessel(i)
    !|  end do
    !|
    !| close(13)
    !| STOP
