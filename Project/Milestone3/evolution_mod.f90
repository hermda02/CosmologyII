    ...
    do k = 1, n_k
       ...
       do i = 1,6
          if (k == prints(i)) then
             ...
             write(28,'(5(E17.8))') x_total(1), Phi(1,k), Psi(1,k), Theta(1,0,k), Theta(1,1,k)
          end if
       end do  
       ...
       do while (x_total(j) < x_tc)
            ...
            do i = 1,6
               if (k == prints(i)) then
                  ...
                  write(28,'(5(E17.8))') x_total(j), Phi(j,k), Psi(j,k), Theta(j,0,k), Theta(j,1,k)
               end if
            end do
            j = j+1
       end do  
       ...
       do i = j_tc,1000+n_t
          ...
          do j = 1,6
             if (k == prints(j)) then
                write(27,'(5(E17.8))') x_total(i), delta(i,k), delta_b(i,k), v(i,k), v_b(i,k)
                write(28,'(5(E17.8))') x_total(i), Phi(i,k), Psi(i,k), Theta(i,0,k), Theta(i,1,k)
             end if
          end do
